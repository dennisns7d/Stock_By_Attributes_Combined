...
// matching record found, can do add and then report. @TODO
          ...
          if ($quantity_affected > 0) {
            ...
            $messageStack->add_session(sprintf(PWA_ADJUST_QUANTITY_SUCCESS, $seachPID, $products_answer->fields['stock_id'], $change, $final_quantity), 'success');
            zen_redirect(zen_href_link(FILENAME_PRODUCTS_WITH_ATTRIBUTES_STOCK, zen_get_all_get_params(array('action', 'pwas-search-button', /*'search'*/)) . '&search=' . $s, $request_type));
          }
